...
public class AfegirJugador {
	...
	private void initialize(ControlBBDD controlBBDD) {
		...
		FCLUB = new JTextField();
		FCLUB.setColumns(10);
		
		FPOSICIO = new JTextField();
		FPOSICIO.setColumns(10);
		...
		afegir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					controlBBDD.afegirJugador(FNom.getText(), FCONGNOM1.getText(), FCONGNOM2.getText(), FCLUB.getText(), FPOSICIO.getText());
				} catch (Exception e1) {
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addComponent(lblAfageixLesDades)
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(lblNom)
								...
								.addComponent(lblClubActual, GroupLayout.PREFERRED_SIZE, 86, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblPosicio, GroupLayout.PREFERRED_SIZE, 86, GroupLayout.PREFERRED_SIZE))
							.addGap(27)
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(FPOSICIO, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addComponent(FCLUB, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addComponent(FCONGNOM2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addComponent(FCONGNOM1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addComponent(FNom, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
